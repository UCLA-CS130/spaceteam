...
SERVER_SOURCE = connection.cc server.cc main.cc config_parser.cc request_parser.cc request_handler.cc response.cc header.cc
CONNECTION_SOURCE = connection.cc request_parser.cc request_handler.cc
CONFIG_TEST_SOURCE = config_parser_test.cc config_parser.cc $(GTEST_DIR)/src/gtest_main.cc
SERVER_TEST_SOURCE = server_test.cc server.cc $(GTEST_DIR)/src/gtest_main.cc config_parser.cc connection.cc request_parser.cc request_handler.cc
CONNECTION_TEST_SOURCE = connection_test.cc connection.cc $(GTEST_DIR)/src/gtest_main.cc request_parser.cc request_handler.cc
