...
CLASSES = config_parser/config_parser src/server src/connection src/request src/request_handler src/response src/server_info src/echo_handler src/static_handler src/not_found_handler
SOURCES = $(CLASSES:=.cc)
OBJECTS = $(CLASSES:=.o)
